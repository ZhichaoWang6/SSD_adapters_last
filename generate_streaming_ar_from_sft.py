...
def parse_args():
    ...
    parser.add_argument("--input_jsonl", type=str, default="/data/wangzhichao/datasets/MMDuet2-data/sft/egoexo4d-half_multi_half_single_question-2_sec_per_frame-sft.jsonl")
