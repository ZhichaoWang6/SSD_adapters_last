...
def parse_args():
    ...
    parser.add_argument("--input", type=str, default="/data/wangzhichao/datasets/ShareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json",
                        help="ShareGPT JSON (list of {id, conversations: [{from, value}]})")
    parser.add_argument("--output", type=str, default="/data/wangzhichao/projects/SSD_full_history/data/sharegpt_for_adapter.jsonl",
