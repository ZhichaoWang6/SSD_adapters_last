...
def get_single_speedup(jsonl_file, jsonl_file_base):
    tokenizer_path="/data/wangzhichao/models/Vicuna-7b-v1.3"
...
def get_mean_speedup():
    ...
    jsonl_file_run_list = [
        "/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-kangaroo-thres-0.6-steps-6-float16/0.jsonl",
        "/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-kangaroo-thres-0.6-steps-6-float16/1.jsonl",
        "/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-kangaroo-thres-0.6-steps-6-float16/2.jsonl"
                           ]
    jsonl_file_base_run_list = [
        "/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-vanilla-float16-temp-0.0/0.jsonl",
        "/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-vanilla-float16-temp-0.0/1.jsonl",
        "/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-vanilla-float16-temp-0.0/2.jsonl"
                           ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--file-path",
        default='/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-kangaroo-thres-0.6-steps-6-float16/0.jsonl',
        type=str,
        help="The file path of evaluated Speculative Decoding methods.",
    )
    parser.add_argument(
        "--base-path",
        default='/home/wangzhichao/Kangaroo/data/Kangaroo/vicuna-7b-v1.3-vanilla-float16-temp-0.0/0.jsonl',
        type=str,
