...
bigname="/data/wangzhichao/models/Vicuna-7b-v1.3"
...
def build_dataset_rank(
        ...
        select=None,
        data_path = "/data/wangzhichao/datasets/ShareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json"
):
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples['id'])):
            ...
            for i, turn in enumerate(turns):
                ...
                turn_len = len(tokenizer(turn, truncation=True, max_length=tokenizer.model_max_length).input_ids)
                ...
                instruction_len = len(tokenizer(parts[0], truncation=True, max_length=tokenizer.model_max_length).input_ids) - 2
